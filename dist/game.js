(() => {
  ...
  function Oe(r, t, u) {
    ...
    if (r instanceof x && t instanceof x)
      return r.lerp(t, u);
    if (r instanceof z2 && t instanceof z2)
      return r.lerp(t, u);
  ...
  o(S, "vec2");
  var _a2;
  var z2 = (/* @__PURE__ */ __name(_a2 = class {
    constructor(t, u, p) {
  ...
  function J(...r) {
    if (r.length === 0)
      return new z2(255, 255, 255);
    if (r.length === 1) {
      if (r[0] instanceof z2)
        return r[0].clone();
      if (typeof r[0] == "string")
        return z2.fromHex(r[0]);
      if (Array.isArray(r[0]) && r[0].length === 3)
        return z2.fromArray(r[0]);
    }
    return new z2(...r);
  }
  __name(J, "J");
  o(J, "rgb");
  var bs = o((r, t, u) => z2.fromHSL(r, t, u), "hsl2rgb");
  var _a3;
  ...
  var wt = /* @__PURE__ */ __name((/* @__PURE__ */ __name(_a5 = class {
    ...
    genColor(t, u) {
      return new z2(this.genNumber(t.r, u.r), this.genNumber(t.g, u.g), this.genNumber(t.b, u.b));
    }
    genAny(...t) {
      if (t.length === 0)
        return this.gen();
      if (t.length === 1) {
        ...
        if (t[0] instanceof z2 && t[1] instanceof z2)
...
`;
  ...
  var bo = o((r = {}) => {
    ...
    let b = (() => {
      ...
      r.background && (i = z2.fromArray(r.background), a = (_a21 = r.background[3]) != null ? _a21 : 1, h.clearColor(i.r / 255, i.g / 255, i.b / 255, a)), h.enable(h.BLEND), h.blendFuncSeparate(h.SRC_ALPHA, h.ONE_MINUS_SRC_ALPHA, h.ONE, h.ONE_MINUS_SRC_ALPHA);
    ...
    function oe(e = Hn, n = qn) {
      ...
      return h.deleteShader(a), h.deleteShader(c), { bind() {
        ...
        for (let m in w) {
          ...
          typeof l == "number" ? h.uniform1f(g, l) : l instanceof Ue ? h.uniformMatrix4fv(g, false, new Float32Array(l.m)) : l instanceof z2 ? h.uniform3f(g, l.r, l.g, l.b) : l instanceof x && h.uniform2f(g, l.x, l.y);
        }
      } };
    }
    __name(oe, "oe");
    ...
    function dt(e) {
      ...
      let i = e.width || 1, a = s.sub(n).unit().normal().scale(i * 0.5), c = [n.sub(a), n.add(a), s.add(a), s.sub(a)].map((f) => {
        var _a21, _b2;
        return { pos: new x(f.x, f.y), uv: new x(0), color: (_a21 = e.color) != null ? _a21 : z2.WHITE, opacity: (_b2 = e.opacity) != null ? _b2 : 1 };
      });
    ...
    function He(e) {
      ...
      if (!(n < 3)) {
        if (K(), v(e.pos), T(e.scale), I(e.angle), v(e.offset), e.fill !== false) {
          let s = (_a21 = e.color) != null ? _a21 : z2.WHITE, i = e.pts.map((c, f) => {
            var _a22, _b3;
...
`), font: Wt, pos: S(e, -e), anchor: "botleft", size: 16, width: be() * 0.6, lineSpacing: e / 2, fixed: true, styles: { time: { color: J(127, 127, 127) }, info: { color: J(255, 255, 255) }, error: { color: J(255, 0, 127) } } });
  ...
  function generateQuestion(min, max, ensureSmallerOperand, opname, opfunc) {
    if (opname === "/") {
      let answer2 = randi(1, max);
      let num22 = randi(1, max);
      let num12 = answer2 * num22;
      let question2 = `${num12} \xF7 ${num22} =`;
      return [question2, answer2];
    }
    num1 = randi(min, max);
  ...
  __name(generateQuestion, "generateQuestion");
  function addDialog() {
    const bg = add([
      rect(width(), 160),
      pos(0, height()),
  ...
  var music1 = play("AckWoi", {
    volume: 0.8,
    loop: true
  });
  var music2 = play("Elderberry", {
    volume: 0.8,
    loop: true
  });
  var music3 = play("WorkinginNY", {
    volume: 0.8,
    loop: true
  });
  var music4 = play("Honey", {
    volume: 0.8,
    loop: true
  });
  var music5 = play("GoodDeeds", {
    volume: 0.8,
    loop: true
  });
  var music6 = play("Hasta", {
    volume: 0.8,
    loop: true
  });
  ...
  __name(stop_all_music, "stop_all_music");
  stop_all_music();
  ...
  scene("start", () => {
    ...
    scale(Math.max(width() / 1080, height() / 2080)), addButton("Start", vec2(width() / 2, height() - 2 - 270), () => go("gametypeselection"));
  ...
  scene("gametypeselection", () => {
    ...
    currentLevel = 1, addButton("Normal Mode (Play the game all at once)", vec2(width() / 2, height() - 2 - 450), () => {
  ...
  scene("help", () => {
    ...
    add([
      sprite("plain"),
      pos,
      vec2(width() / 2 - 4 * 64, height() / 2 - 3 * 64)
    ]);
    add([
      pos(width() / 25, height() / 7),
      text("How to Play", {
  ...
  scene("level", () => {
    ...
    if (currentLevel === 5) {
      ...
      stop_all_music();
      musics[levelIx2].play();
      add([
        sprite(bgs[levelIx2][0]),
        scale(Math.max(width() / bgs[levelIx2][1], height() / bgs[levelIx2][2])),
        fixed()
      ]);
      const level = addLevel(LEVELS[levelIx2], LEVELOPTS);
      ...
      player.onCollide("door", () => {
        if (hasKey) {
          if (currentLevel === 1) {
            go("mathstime", 0, 20, false, "+", (a, b) => {
              return a + b;
            });
            currentLevel = 2;
          } else if (currentLevel === 2) {
            go("mathstime", 0, 20, true, "-", (a, b) => {
              return a - b;
            });
            currentLevel = 3;
          } else if (currentLevel === 3) {
            go("mathstime", 0, 12, false, "\xD7", (a, b) => {
              return a * b;
            });
            currentLevel = 4;
          } else if (currentLevel === 4) {
            go("mathstime", 1, 10, true, "/", (a, b) => {
              return a * b;
            });
            currentLevel = 5;
          } else {
